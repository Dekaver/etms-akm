    ...
    public function annualtireconsumption(Request $request, TireMaster $tire)
    {
        ...
        if ($request->ajax()) {
            if ($grup == 'driver') {
                $query = HistoryTireMovement::select(
                    "drivers.nama as unit",
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 1 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new1'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 1 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare1'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 1 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap1'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 2 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new2'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 2 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare2'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 2 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap2'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 3 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new3'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 3 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare3'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 3 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap3'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 4 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new4'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 4 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare4'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 4 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap4'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 5 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new5'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 5 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare5'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 5 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap5'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 6 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new6'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 6 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare6'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 6 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap6'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 7 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new7'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 7 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare7'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 7 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap7'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 8 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new8'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 8 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare8'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 8 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap8'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 9 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new9'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 9 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare9'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 9 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap9'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 10 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new10'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 10 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare10'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 10 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap10'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 11 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new11'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 11 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare11'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 11 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap11'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 11 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new11'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 11 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare11'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 11 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap11'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 12 AND status = 'NEW' THEN 1 ELSE 0 END) AS 'new12'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 12 AND status = 'SPARE' THEN 1 ELSE 0 END) AS 'spare12'"),
                    DB::raw("SUM(CASE WHEN MONTH(history_tire_movements.created_at) = 12 AND status = 'SCRAP' THEN 1 ELSE 0 END) AS 'scrap12'")
                )
                    ->leftJoin("drivers", "drivers.id", "=", "history_tire_movements.driver_id")
