...
var tire_lifetime_average = new ApexCharts(
...
$.getJSON(url, function (response) {
    ...
    tire_lifetime_average.updateSeries();
    tire_lifetime_average.updateOptions({
        ...
        xaxis: {
            ...
            categories: response["type_brand_size"],
            tickPlacement: "on",
        },
