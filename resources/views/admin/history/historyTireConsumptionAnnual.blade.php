        ...
        <script type="text/javascript">
            $(function() {
                var table = $('table.data-table').DataTable({
                    ...
                    columnDefs: [
                    {
                        targets: [37], // Indeks kolom yang ingin Anda beri warna
                    ...
                    {
                        targets: [38], // Indeks kolom yang ingin Anda beri warna
                        render: function(data, type, row, meta) {
                    ...
                    {
                        targets: [39], // Indeks kolom yang ingin Anda beri warna
                        render: function(data, type, row, meta) {
