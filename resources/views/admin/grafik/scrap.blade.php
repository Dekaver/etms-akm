<x-app-layout>
    ...
    <h4 class="text-center">TIRE SCRAP</h4>
    <div class="row">
        <div class="col-xl-12">
            <div class="card o-hidden">
                <div class="card-header pb-0">
                    <h5>Tire SCRAP INJURY
                ...
                <div class="bar-chart-widget">
                    <div class="bottom-content card-body">
                        <div class="row">
                            <div class="col-12">
                                <div id="chart-tire-scrap-injury"
                                    data-url="{{ str_replace(Request::url(), url('grafik-tire-scrap-injury'), Request::fullUrl()) }}">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @push('js')
        <script src="{{ asset('assets\view\grafik-scrap.js') }}"></script>
        <script>
